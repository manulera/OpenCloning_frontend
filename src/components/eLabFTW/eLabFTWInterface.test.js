...
formDataWithAncestors.append('file', new Blob([JSON.stringify(substateWithAncestors)], { type: 'text/plain' }));
...
const substateWithPrimersAndNewPrimerDatabaseId = JSON.parse(JSON.stringify(substateWithPrimers));
